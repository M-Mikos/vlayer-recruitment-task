  ...
  "inline-flex items-center justify-center gap-2 border-2 px-6 py-3 whitespace-nowrap rounded-lg text-base font-bold transition-all disabled:pointer-events-none [&_svg]:pointer-events-none [&_svg:not([class*='size-'])]:size-4 shrink-0 [&_svg]:shrink-0 outline-none focus-visible:border-ring",
  {
    variants: {
      variant: {
        ...
        icon: "w-12 h-12 px-0 py-0 rounded-full text-secondary-500 bg-transparent border-neutral-200 hover:border-secondary-300 hover:text-secondary-700 focus-visible:border-secondary-300 focus-visible:text-secondary-700 focus-visible:bg-secondary-200/20 active:border-secondary-300 active:bg-secondary-500 active:text-white",
